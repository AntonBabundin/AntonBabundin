...
//     *
//------------------------------------------------------------------------------
class gen_eht_trig_test extends base_tst;
  `uvm_component_utils(gen_eht_trig_test)
  //----
    extern function      new(string name = "gen_eht_trig_test", uvm_component parent = null);
    extern function void build_phase(uvm_phase phase);
endclass: gen_eht_trig_test

//----
function gen_eht_trig_test::new(string name = "gen_eht_trig_test", uvm_component parent = null);
    super.new (name, parent);
endfunction: new

//----
function void gen_eht_trig_test::build_phase(uvm_phase phase);
  ...
  //----
    uvm_config_db#(uvm_object_wrapper)::set(this,"m_env.m_vsqr.run_phase", "default_sequence", gen_eht_trig_sq::type_id::get());
