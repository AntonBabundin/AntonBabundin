...
//     *
//------------------------------------------------------------------------------
class gen_he_mu_sq extends base_sq;
    `uvm_object_utils(gen_he_mu_sq)
    //----
    ...
    //----
    extern function      new(string name = "gen_he_mu_sq");
...
function gen_he_mu_sq::new(string name = "gen_he_mu_sq");
    super.new (name);
endfunction: new

task gen_he_mu_sq::pre_body();
