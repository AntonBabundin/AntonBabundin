...
//     *
//------------------------------------------------------------------------------
class gen_eht_su_gamma_rot_sq extends base_sq;
    `uvm_object_utils(gen_eht_su_gamma_rot_sq)
    //----
    ...
    //----
    extern function      new(string name = "gen_eht_su_gamma_rot_sq");
...
function gen_eht_su_gamma_rot_sq::new(string name = "gen_eht_su_gamma_rot_sq");
    super.new (name);
endfunction: new

task gen_eht_su_gamma_rot_sq::pre_body();
...
task gen_eht_su_gamma_rot_sq :: send_stf();
...
task gen_eht_su_gamma_rot_sq :: send_ltf();
    `uvm_create_on(trn, p_sequencer.m_dyn_pre_gen_sqr)
    fork
        begin            
            @(posedge $root.tb_hdl_top.clk);
...
task gen_eht_su_gamma_rot_sq :: body();
