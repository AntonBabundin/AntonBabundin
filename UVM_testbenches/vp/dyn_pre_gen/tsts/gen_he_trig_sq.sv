...
//     *
//------------------------------------------------------------------------------
class gen_he_trig_sq extends base_sq;
    `uvm_object_utils(gen_he_trig_sq)
    //----
    ...
    //----
    extern function      new(string name = "gen_he_trig_sq");
...
function gen_he_trig_sq::new(string name = "gen_he_trig_sq");
    super.new (name);
endfunction: new
