...
class gen_non_ht_sq extends base_sq;
   ...
   bit [GEN_GPIO_WIDTH - 1:0]                  END_SYS_PATTERN;    
    ...
    //----
    extern function      new(string name = "gen_non_ht_sq");
...
function gen_non_ht_sq::new(string name = "gen_non_ht_sq");
    super.new (name);
endfunction: new

task gen_non_ht_sq::pre_body();
    ...
    START_SYS_PATTERN = {1'b0, 1'b0, format_non_ht, 1'b0, 1'b0, 1'b0, 1'b0, 1'b1, 1'b0, ch_tx, nhtp_4ch, pkt_bw, sys_bw, mu_subband_punct_coeff, gamma_rotation_coeff};
    START_STF_PATTERN = {1'b0, 1'b0, format_non_ht, 1'b0, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0, ch_tx, nhtp_4ch, pkt_bw, sys_bw, mu_subband_punct_coeff, gamma_rotation_coeff};
    START_LTF_PATTERN = {1'b0, 1'b1, format_non_ht, 1'b0, 1'b0, 1'b0, 1'b1, 1'b0, 1'b0, ch_tx, nhtp_4ch, pkt_bw, sys_bw, mu_subband_punct_coeff, gamma_rotation_coeff};
    END_LTF_PATTERN   = {1'b0, 1'b1, format_non_ht, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, ch_tx, nhtp_4ch, pkt_bw, sys_bw, mu_subband_punct_coeff, gamma_rotation_coeff};
    END_SYS_PATTERN   = {1'b0, 1'b0, format_non_ht, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, ch_tx, nhtp_4ch, pkt_bw, sys_bw, mu_subband_punct_coeff, gamma_rotation_coeff};

    run_ref_model_for_chain(int'(sys_bw), int'(pkt_bw), int'(format_non_ht), 
    int'(gamma_rotation_coeff), int'(mu_subband_punct_coeff), int'(ch_tx), int'(nhtp_4ch));
endtask: pre_body


task gen_non_ht_sq :: send_stf();
