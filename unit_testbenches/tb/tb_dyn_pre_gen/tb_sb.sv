...
task tb_sb::hoarder();
    forever begin
        ...
        join
        case(gen_din_wrd.sys_bw)
            'd0     : NUM_OF_DEL_TRNS = 6;
            default : NUM_OF_DEL_TRNS = 7;
        endcase
        if (delete_trn >= NUM_OF_DEL_TRNS) -> e_new_trn; // Delete NUM_OF_DEL_TRNS trns and then start analyz
    end
endtask: hoarder
//----
...
task tb_sb::analyzer();
    ...
    forever begin
        ...
        c_sample_0_chan.im_val[11:0] === gen_dout_wrd.data_q_1);
