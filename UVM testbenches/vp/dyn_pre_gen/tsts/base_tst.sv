...
class base_tst extends uvm_test;     //all tests should derive from uvm_test and use `uvm_component_utils
    ...
    qcs_dyn_pre_gen_cfg         m_gen_in_ag_cfg0;
    qcs_dyn_pre_gen_cfg_out     m_gen_out_ag_cfg0;
    //----
...
function void base_tst::build_phase(uvm_phase phase);
    ...
    // gen agents configuration
    m_gen_in_ag_cfg0 = qcs_dyn_pre_gen_cfg::type_id::create("m_gen_in_ag_cfg0", this);
    m_gen_in_ag_cfg0.active = UVM_ACTIVE;
    uvm_config_db#(qcs_dyn_pre_gen_cfg)::set(this, "*m_gen_in_ag*", "m_cfg", m_gen_in_ag_cfg0);

    m_gen_out_ag_cfg0 = qcs_dyn_pre_gen_cfg_out::type_id::create("m_gen_out_ag_cfg0", this);
    m_gen_out_ag_cfg0.active = UVM_PASSIVE;
    uvm_config_db#(qcs_dyn_pre_gen_cfg_out)::set(this, "*m_gen_out_ag*", "m_cfg", m_gen_out_ag_cfg0);
