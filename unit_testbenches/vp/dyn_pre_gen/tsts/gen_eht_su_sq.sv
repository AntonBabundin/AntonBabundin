...
//     *
//------------------------------------------------------------------------------
class gen_eht_su_sq extends base_sq;
    `uvm_object_utils(gen_eht_su_sq)
    //----
    ...
    localparam logic unsigned [4 : 0]           format_eht_su          = 8;
    //----
    int gamma_rotation_coeff;
    //----
    localparam bit [GEN_GPIO_WIDTH - 1:0] START_SYS_PATTERN = {1'b0, 1'b0, format_eht_su, 1'b0, 1'b0, 1'b0, 1'b0, 1'b1, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] START_STF_PATTERN = {1'b0, 1'b0, format_eht_su, 1'b0, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] START_LTF_PATTERN = {1'b0, 1'b1, format_eht_su, 1'b0, 1'b0, 1'b0, 1'b1, 1'b0, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] END_LTF_PATTERN   = {1'b0, 1'b1, format_eht_su, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] END_SYS_PATTERN   = {1'b0, 1'b0, format_eht_su, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0};
    //----
    c_model_queues   m_model_queues;
    //----
    extern function      new(string name = "gen_eht_su_sq");
...
function gen_eht_su_sq::new(string name = "gen_eht_su_sq");
    super.new (name);
endfunction: new

task gen_eht_su_sq::pre_body();
