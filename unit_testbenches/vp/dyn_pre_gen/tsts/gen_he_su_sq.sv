...
class gen_he_su_sq extends base_sq;
    ...
    logic unsigned [4 : 0]                      format_he_su           = 4;
    //----
...
task gen_he_su_sq::pre_body();
    ...
    START_SYS_PATTERN = {1'b0, 1'b0, format_he_su, 1'b0, 1'b0, 1'b0, 1'b0, 1'b1, 1'b0, ch_tx, nhtp_4ch, pkt_bw, sys_bw, mu_subband_punct_coeff, gamma_rotation_coeff};
    START_STF_PATTERN = {1'b0, 1'b0, format_he_su, 1'b0, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0, ch_tx, nhtp_4ch, pkt_bw, sys_bw, mu_subband_punct_coeff, gamma_rotation_coeff};
    START_LTF_PATTERN = {1'b0, 1'b1, format_he_su, 1'b0, 1'b0, 1'b0, 1'b1, 1'b0, 1'b0, ch_tx, nhtp_4ch, pkt_bw, sys_bw, mu_subband_punct_coeff, gamma_rotation_coeff};
    END_LTF_PATTERN   = {1'b0, 1'b1, format_he_su, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, ch_tx, nhtp_4ch, pkt_bw, sys_bw, mu_subband_punct_coeff, gamma_rotation_coeff};
    END_SYS_PATTERN   = {1'b0, 1'b0, format_he_su, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, ch_tx, nhtp_4ch, pkt_bw, sys_bw, mu_subband_punct_coeff, gamma_rotation_coeff};
