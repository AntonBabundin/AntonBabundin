...
class gen_non_ht_sq extends base_sq;
    ...
    //----
    logic unsigned [GEN_BW_W - 1 : 0]           pkt_bw                 = 0;
    logic unsigned [GEN_SUBBAND_W - 1 : 0]      mu_subband_punct_coeff = 16'hFFFF;
    localparam logic unsigned [4 : 0]                      format_non_ht          = 0;
    //----
    int gamma_rotation_coeff;
    //----
    localparam bit [GEN_GPIO_WIDTH - 1:0] START_SYS_PATTERN = {1'b0, 1'b0, format_non_ht, 1'b0, 1'b0, 1'b0, 1'b0, 1'b1, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] START_STF_PATTERN = {1'b0, 1'b0, format_non_ht, 1'b0, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] START_LTF_PATTERN = {1'b0, 1'b1, format_non_ht, 1'b0, 1'b0, 1'b0, 1'b1, 1'b0, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] END_LTF_PATTERN   = {1'b0, 1'b1, format_non_ht, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] END_SYS_PATTERN   = {1'b0, 1'b0, format_non_ht, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0};
    //----
