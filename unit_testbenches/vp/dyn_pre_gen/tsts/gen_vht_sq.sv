...
class gen_vht_sq extends base_sq;
    ...
    localparam logic unsigned [4 : 0]           format_vht             = 3;
    //----
    int gamma_rotation_coeff;
    //----
    localparam bit [GEN_GPIO_WIDTH - 1:0] START_SYS_PATTERN = {1'b0, 1'b0, format_vht, 1'b0, 1'b0, 1'b0, 1'b0, 1'b1, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] START_STF_PATTERN = {1'b0, 1'b0, format_vht, 1'b0, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] START_LTF_PATTERN = {1'b0, 1'b1, format_vht, 1'b0, 1'b0, 1'b0, 1'b1, 1'b0, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] END_LTF_PATTERN   = {1'b0, 1'b1, format_vht, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0};
    localparam bit [GEN_GPIO_WIDTH - 1:0] END_SYS_PATTERN   = {1'b0, 1'b0, format_vht, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0};
    //----
