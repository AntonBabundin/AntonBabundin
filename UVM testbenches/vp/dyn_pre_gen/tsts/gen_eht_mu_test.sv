...
//     *
//------------------------------------------------------------------------------
class gen_eht_mu_test extends base_tst;
  `uvm_component_utils(gen_eht_mu_test)
  //----
    extern function      new(string name = "gen_eht_mu_test", uvm_component parent = null);
    extern function void build_phase(uvm_phase phase);
endclass: gen_eht_mu_test

//----
function gen_eht_mu_test::new(string name = "gen_eht_mu_test", uvm_component parent = null);
    super.new (name, parent);
endfunction: new

//----
function void gen_eht_mu_test::build_phase(uvm_phase phase);
