...
//     *
//------------------------------------------------------------------------------
class gen_eht_trig_sq extends base_sq;
    `uvm_object_utils(gen_eht_trig_sq)
    //----
    ...
    //----
    extern function      new(string name = "gen_eht_trig_sq");
...
function gen_eht_trig_sq::new(string name = "gen_eht_trig_sq");
    super.new (name);
endfunction: new

task gen_eht_trig_sq::pre_body();
