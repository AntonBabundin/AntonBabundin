...
//     *
//------------------------------------------------------------------------------
class gen_eht_trig_punct_sq extends base_sq;
    `uvm_object_utils(gen_eht_trig_punct_sq)
    //----
    ...
    //----
    extern function      new(string name = "gen_eht_trig_punct_sq");
...
function gen_eht_trig_punct_sq::new(string name = "gen_eht_trig_punct_sq");
    super.new (name);
endfunction: new

task gen_eht_trig_punct_sq::pre_body();
...
task gen_eht_trig_punct_sq :: send_stf();
...
task gen_eht_trig_punct_sq :: send_ltf();
    `uvm_create_on(trn, p_sequencer.m_dyn_pre_gen_sqr)
    fork
        begin            
            @(posedge $root.tb_hdl_top.clk);
...
task gen_eht_trig_punct_sq :: body();
